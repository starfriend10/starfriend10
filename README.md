### **Latest Updates**
**2025-01** The long form QA dataset used in our recent GPT paper is now shared in the Github respsitory [LLMQA](https://github.com/starfriend10/LLMQA). Tne dataset includes 286 QA data focusing on Biological Wastewater Treatment and was used in our recent [GPT assessment paper](https://doi.org/10.1021/acs.estlett.4c00665). The respsitory will be used for storing and sharing future environmental datasets curated for large language model development.
